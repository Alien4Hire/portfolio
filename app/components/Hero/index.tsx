...
const HomeHero: React.FC = () => {
  return (
    <section className="relative min-h-screen bg-[#1a1a1a] text-white flex flex-col justify-center items-center overflow-hidden px-4 py-10 md:px-0 md:py-0 md:pl-32 lg:pl-48 md:flex md:flex-col md:justify-center md:items-start">
